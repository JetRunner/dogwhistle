...
class InsiderProcessor(DataProcessor):
    ...
    def _create_examples(self, lines: List[List[str]], type: str):
        ...
        examples = [
            InputExample(
                example_id=line[0],
                question=line[3],  # in the swag dataset, the
                # common beginning of each
                # choice is stored in "sent2".
                contexts=[line[2],line[2],line[2],line[2]],
                endings=line[1].split(','),
                label=line[4],
            )
...
class OutsiderProcessor(DataProcessor):
    """Processor for the Synonym data set."""
...
processors = {'insider': InsiderProcessor, 'outsider': OutsiderProcessor}
MULTIPLE_CHOICE_TASKS_NUM_LABELS = {"insider", 4, "outsider", 4}
